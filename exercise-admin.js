(function(){
  ...
  window.exercises=function(filter){
    ...
    const items=lib();
    const counts={all:items.length,ai:0,local:0,manual:0,image:0,web:0,instagram:0};
    ...
    const tabs=[
      ['all','Tutti',counts.all],['ai','✨ AI',counts.ai],['local','⚙️ App',counts.local],['image','📷 Immagini',counts.image],['web','🌐 Web',counts.web],['instagram','📱 Instagram',counts.instagram],['manual','✍️ Manuali',counts.manual]
